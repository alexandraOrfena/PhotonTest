...
public class PhotonService : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    private IBasicSpawner _basicSpawner;

    [Inject]
    public void Init(IInputProvider inputProvider, IBasicSpawner basicSpawner)
    {
    ...
    void INetworkRunnerCallbacks.OnPlayerJoined(NetworkRunner runner, PlayerRef player)
    {
        ...
        if (runner.IsServer)
        {
            _basicSpawner.Spawn(runner, player);
        }
    ...
    void INetworkRunnerCallbacks.OnPlayerLeft(NetworkRunner runner, PlayerRef player)
    {
        ...
        _basicSpawner.Despawn(runner, player);
    }
